...
export const timelinePhases = [
  ...
  },
  {
    period: "May 2026",
    name: "Transfer",
    desc: "Team operates independently. Playbook ready for enterprise rollout.",
  },
];
...
export const decisionLog = [
  {
    ...
    rationale:
      "Marketing had the highest density of repetitive, AI-automatable tasks combined with a CMO willing to sponsor the experiment. Engineering and Sales had neither.",
  },
  {
