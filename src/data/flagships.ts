...
export const flagships: Flagship[] = [
  ...
  },
  {
    ...
    body: "A fully automated outbound pipeline, run as one system rather than a stack of disconnected tools. Five stages — discover, enrich, sequence, agent feedback, converted prospect — each hand a cleaner record to the next. The data platform supplies targeting and enrichment, Apollo carries the sequences, and the agent feedback stage closes the loop. The architecture below is the system as built.",
  ...
  },
  {
    ...
    body: "An executive reasoning engine built for the CMO: attribution, funnel analysis, and ROI modeling over the marketing data estate. Questions that once waited in an analyst queue come back in minutes. Twenty tools sit behind the conversation, and every release runs a 110-question test suite before it ships — the current pass rate is 100%.",
